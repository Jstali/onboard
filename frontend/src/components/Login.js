...
import ManagerPasswordSetup from "./ManagerPasswordSetup";
...
const Login = () => {
  ...
  // Manager first login state
  const [showManagerPasswordSetup, setShowManagerPasswordSetup] =
    useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.requiresPasswordSetup) {
        // Show manager password setup form
        setManagerData({
        ...
        setShowManagerPasswordSetup(true);
        setPassword("");
        setLoading(false);
  ...
  return (
    <>
      {showManagerPasswordSetup ? (
        <ManagerPasswordSetup
          userData={managerData}
          onPasswordSet={() => setShowManagerPasswordSetup(false)}
        />
      ) : (
